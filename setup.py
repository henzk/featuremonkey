...
setup(
    ...
    url='https://github.com/henzk/featuremonkey',
    ...
    packages=['featuremonkey', 'featuremonkey.test', 'featuremonkey.test.mock', 'featuremonkey.test.mock.testpackage1', 'featuremonkey.tracing'],
